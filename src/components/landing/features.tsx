...
function Feature({ icon, title, description, delay = 0 }: FeatureProps) {
  return (
    <motion.div
      className="p-6 border rounded-xl shadow-sm transition-all hover:shadow-md bg-card"
        ...
        >
          <div className="inline-flex items-center rounded-md overflow-hidden border border-primary/30">
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
              <a
                href="#"
                className="px-5 py-2 bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-colors"
              >
                View Documentation
              </a>
            </motion.div>
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
              <a
                href="#"
                className="px-5 py-2 bg-background text-primary font-medium hover:bg-muted transition-colors"
              >
                Try Demo
              </a>
            </motion.div>
